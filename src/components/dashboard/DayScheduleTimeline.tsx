    ...
    <div className="flex flex-col gap-2 pb-4">
      ...
      <div className="flex items-center justify-between px-1 mb-1">
        ...
        <span className="text-[11px] font-mono text-zinc-400">
          Выполнено: <strong className="text-[#ccff00]">{completedSlotsCount}</strong> / {totalSlots}
        </span>
      </div>
          ...
          return (
            <button
              ...
              className={`w-full p-2.5 rounded-xl border flex items-center justify-between text-left transition-all duration-200 active:scale-98 ${
                isCompleted
                  ? 'bg-zinc-900/60 border-[#ccff00]/30 text-zinc-300'
                  : 'bg-[#12151f]/80 backdrop-blur-md border-white/[0.08] hover:border-[#ccff00]/30 text-white'
              }`}
            >
              ...
              <div className="flex items-center gap-3 min-w-0">
                <span
                  className={`text-xs font-mono px-2 py-0.5 rounded border shrink-0 font-bold ${
                    isCompleted
                      ? 'bg-[#ccff00]/10 border-[#ccff00]/25 text-[#ccff00] line-through'
                      : 'bg-zinc-800/80 border-white/10 text-[#ccff00]'
                  }`}
                >
                  {slot.time}
                </span>
              ...
              <div className="shrink-0 ml-2">
                {isCompleted ? (
                  <span className="flex items-center gap-1 px-2 py-1 rounded-lg bg-[#ccff00]/15 border border-[#ccff00]/30 text-[#ccff00] text-[10px] font-mono font-medium">
                    <Check className="w-3 h-3 stroke-[3]" />
                    Сделано
                  </span>
                ) : (
                  <span className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-[#ccff00] hover:bg-[#d9f99d] text-black text-[10px] font-bold uppercase tracking-wider shadow-sm shadow-[#ccff00]/25">
